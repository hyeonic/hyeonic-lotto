...
### 등수 계산
 * [ ] 당첨 번호를 기반으로 등수를 계산한다.
 * [ ] 6개의 숫자가 전부 맞으면 1등 상금으로 500만원을 받는다.
 * [ ] 5개의 숫자만 맞으면 2등 상금으로 50만원을 받는다.
 * [ ] 4개의 숫자만 맞으면 3등 상금으로 5만원을 받는다.
 * [ ] 3개의 숫자만 맞으면 4등 상금으로 5000원을 받는다.
 * [ ] 2개 이하의 숫자 만큼 맞는 경우 상금을 수령할 수 없다.
